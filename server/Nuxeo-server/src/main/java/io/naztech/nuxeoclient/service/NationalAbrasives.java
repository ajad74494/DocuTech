 ...
 */
@Service
public class NationalAbrasives implements PdfInvoiceProcessor {

	private static Logger log = LoggerFactory.getLogger(NationalAbrasives.class);
	@Autowired
	...
	public Invoice processPdfInvoice(String pdfStr, File pdfInvoice) {
		...
		try {
			invoice.setSortName(Constants.NATIONALABRASIVESLTD);
			...
			;
			// ===============Supleyer Address ================
			String[] supleyerAddressA1 = pdfStr.split(suplierAddress);
			...
			// ============order number==========
			String[] ordernumberA1 = pdfStr.split(orderNo);
			...
			// ===============description Address ================
			String[] invoiceTableA1 = pdfStr.split("Price");
