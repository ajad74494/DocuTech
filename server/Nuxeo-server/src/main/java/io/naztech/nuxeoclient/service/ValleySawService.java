 ...
 */
@Service
public class ValleySawService implements PdfInvoiceProcessor {
	private static Logger log = LoggerFactory.getLogger(ValleySawService.class);
	@Autowired
	...
	@Value("${import.valleySaw.Name}")
	private String nuxeoinvoiceName;

	@Value("${import.valleySaw.type}")
	private String nuxeoinvoiceType;

	@Value("${import.valleySaw.prefix}")
	private String prefix;

	@Value("${import.nuxeo.valleySaw.description}")
	private String desc;
	...
	public Invoice processPdfInvoice(String pdfStr, File pdfInvoice) { 
		...
		try {
			...
			try {
				...
				log.info(e.getMessage() + "Error for Table Data");
			}
			invoice.setInvoiceTable(invoiceTable); 
		} catch (Exception e) {
			log.info(e.getMessage() + "Error For Invoice Data");
		}
		return invoice;
