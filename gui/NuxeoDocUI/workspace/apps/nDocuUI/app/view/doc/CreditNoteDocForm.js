Ext.define('Desktop.view.doc.CreditNoteDocForm', {
	extend : 'Ext.form.Panel',
	alias: 'widget.CreditNoteDocForm',
									...
									items: [
										{
											...
											items:[
												...
												{
													xtype: 'textfield',
													fieldLabel: 'Claint Name',
													name: 'claintName',
													reference: 'claintName',
													columnWidth: .25,
													margin: '0 15 0 0',
													labelStyle: 'font-weight:bold'
												},
										...
										},
										{
											...
											items:[
												...
												},
												{
													...
													xtype: 'datefield',
													fieldLabel: 'Credit Date',
													name: 'creditDate',
													reference: 'creditDate',
													columnWidth: .25,
													margin: '0 15 0 0',
													labelStyle: 'font-weight:bold',
													value: new Date()
												...
												{
													xtype: 'numberfield',
													fieldLabel: 'Credit Account No',													
													name: 'creditAccNo',
													reference: 'creditAccNo',													
													emptyText: 'Number',
													hideTrigger: true,
													mouseWheelEnabled: false,
													columnWidth: .25,
