USE [DOCUTECH_DEV]
GO
/****** Object:  StoredProcedure [nDOCUTECH].[UPD_doc]    Script Date: 24/12/2019 10:39:28 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	END
		...
		SET		  id_doc_ver				= id_doc_ver + 1  
				...
				, tx_invoice_number				= ISNULL(@tx_invoice_number 	, tx_invoice_number 	)
				...
				, is_sage50_processed			= ISNULL(@is_sage50_processed	, is_sage50_processed	)
				, tx_trader_reference_no 		= ISNULL(@tx_trader_reference_no , tx_trader_reference_no)
				, id_template_key 				= ISNULL(@id_template_key 		, id_template_key		)
				, tx_supplier_short_name		= ISNULL(@tx_supplier_short_name , tx_supplier_short_name)
